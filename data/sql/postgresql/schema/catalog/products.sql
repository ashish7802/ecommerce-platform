-- Catalog schema with product and user reference data.
CREATE TABLE users (
...
INSERT INTO products (sku, name, category, description, price_cents, inventory_count) VALUES
...
-- Query: fetch all in-stock products ordered by category and name.
SELECT sku, name, category, price_cents, inventory_count
FROM products
WHERE inventory_count > 0
ORDER BY category, name;

-- Query: search for products by category.
